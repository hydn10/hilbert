...
[![CI](https://github.com/hydn10/hilbert/actions/workflows/ci.yml/badge.svg)](https://github.com/hydn10/hilbert/actions/workflows/ci.yml)
...
3. Set `VCPKG_ROOT` to the vcpkg installation directory.
4. Configure, build, and test using the current CMake presets:
...
```bash
just cpp simulate
just py validate-data out/simulation.csv
just py plot out/simulation.csv
```
